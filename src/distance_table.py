"""
Distance Table Builder for Sandhill Crane Migration Networks
============================================================

Precomputes distances between all possible county pairs to avoid
recalculating distances for each year's network construction.
"""
...
class DistanceTableBuilder:
    ...
    def save_distance_table(self, filename='county_distance_table.pkl'):
        """
        Save the distance table to a pickle file (and a CSV for inspection).
        """
        ...
        print("Distance table saved successfully!")
    ...
    def load_distance_table(self, filename='county_distance_table.pkl'):
        """
        Load the distance table from a pickle file.
        """
...
def main():
    print("Building Distance Table for Sandhill Crane Migration Networks")
    print("=" * 80)
